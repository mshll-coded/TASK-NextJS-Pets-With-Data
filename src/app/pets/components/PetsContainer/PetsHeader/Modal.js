  ...
  return (
    <div className="inset-0 fixed  flex justify-center items-center flex-col z-20 overflow-hidden">
      ...
      >
        ...
        <Input title="Pet Name" name="name" value={pet.name} onChange={handleChange} required />
        <Input title="Pet Type" name="type" value={pet.type} onChange={handleChange} required />
        <Input title="Pet Image Link" name="image" value={pet.image} onChange={handleChange} />
